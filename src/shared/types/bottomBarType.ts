...
export const bottomBar: bottomBarData[] = [
  ...
  { label: '관심', icon: InterestIcon, iconClassName: 'w-8 h-7 md:w-10 md:h-9 mb-1', path: '/bookmark' },
  { label: '마이페이지', icon: MypageIcon, iconClassName: 'w-8 h-6 md:w-10 md:h-7', path: '/menu/mypage' },
];
